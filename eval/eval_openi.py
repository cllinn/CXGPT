...
from mulcon.dataloader.openi_loader import OPENI, OPENI_it2t, OPENI_t2t, OPENI_i2t, OPENI_image2findings, OPENI_image2impression
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_path', type=str, default="../dataloader/MIMIC_it2t_test.pt", help="Path to dataset")
    ...
    # checkpoint_path = "/root/autodl-tmp/checkpoint/biogptl-ft/checkpoint.pt-7"
    checkpoint_path = "/root/autodl-tmp/checkpoint/xlip-lm-mimic/checkpoint/checkpoint.pt-0"
    hyp_path = "mimic_hyp.txt"
    ...
    with open("score.txt", "a") as f:
        f.write(f"ft1epoch mimic chestxraygpt it2t " + str(score) + "\n")