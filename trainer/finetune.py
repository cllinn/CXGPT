...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_path', type=str, default="../dataloader/MIMIC_it2t_train.pt", help="Path to dataset")
    parser.add_argument('--val_path', type=str, default="../dataloader/MIMIC_it2t_test.pt", help="Path to val dataset")
    ...
    parser.add_argument('--output_dir', type=str, default="/root/autodl-tmp/checkpoint/fuxian-mimic", help="Output directory")
    ...
    trainer = LMTrainer(epochs, optimizer, model, tokenizer, dataloader, val_loader, lr_scheduler, output_dir)
