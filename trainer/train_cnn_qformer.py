...
from mulcon.dataloader.openi_loader import OPENI, OPENI_i2t, OPENI_it2t, OPENI_t2t, OPENI_image2findings
...
from mulcon.model.cnn_llm import CNNLLM
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default="/root/autodl-tmp/checkpoint/cnn_llm", help="Output directory")
